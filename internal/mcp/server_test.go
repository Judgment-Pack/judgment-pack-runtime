...
func TestServerLifecycleToolsAndValidate(t *testing.T) {
	...
	for _, want := range []string{"validate", "test_conformance", "get_schema", "describe_runtime", "list_examples", "get_example", "list_packs", "get_pack", "get_pack_diagram", "experimental_evaluate"} {
